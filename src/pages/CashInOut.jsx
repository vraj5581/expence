  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card p-3 sm:p-4 rounded-2xl space-y-3">
        ...
        {isFilterOpen && (
          <div className="pt-3 border-t border-slate-200/80 grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
            <div>
              <label className="block text-[10px] font-bold text-slate-500 uppercase mb-1">Select User</label>
              <select
                value={selectedUser}
                onChange={(e) => setSelectedUser(e.target.value)}
                className="w-full px-3 py-1.5 text-xs rounded-xl glass-input text-slate-800 bg-white focus:outline-none font-semibold"
              >
            ...
            {hasActiveFilters && (
              <div className="sm:col-span-3 flex justify-end">
                <button
                  onClick={() => { setSelectedUser('All'); setStartDate(''); setEndDate(''); setSearchTerm(''); }}
